            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4"> 
                    ...
                    <form action="" method="post">
                        <div class="form-group <?=form_error('rekom_name') ? 'has-error' : null?>">
                        <label for="">Nama Unit Pendukung *</label>
                            <input type="hidden" name="rekom_id" value="<?=$row->rekom_id?>">
                            <input type="text" name="rekom_name" value="<?=$this->input->post('rekom_name') ?? $row->rekom_name?>" class="form-control">
                            <?=form_error('rekom_name')?>
                        </div>
