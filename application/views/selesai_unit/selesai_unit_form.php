...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Rekomendasi Proses Ditindaklanjuti</li>
  </ol>
</section>
    ...
    <div class="box">
        <div class="box-header">
            ...
            <div class="pull-right">
                <a href="<?=site_url('selesai_unit')?>" class="btn btn-warning btn-flat"><i class="fa fa-undo"></i> Back</a>
            </div>
        </div>
        <div class="box-body">
            ...
            <div class="row">
                ...
                <?php echo form_open_multipart('selesai_unit/process') ?>
