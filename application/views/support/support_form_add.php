                ...
                <div class="col-md-4 col-md-offset-4"> 
                    ...
                    <form action="" method="post">
                        ...
                        <label for="">Nama Unit Pendukung *</label>
                            <input type="hidden" name="support_id" value="<?=Uuid::uuid4()->toString();?>">
                            <input type="text" name="support_name" value="<?=set_value('support_name')?>" class="form-control">
                            <?=form_error('support_name')?>
                        </div>
                        <div class="form-group <?=form_error('info') ? 'has-error' : null ?>">
                        <label for="">Informasi </label>
                            <input type="text" name="info" value="<?=set_value('info')?>" class="form-control">
                            <?= form_error('info')?>
                        </div>
